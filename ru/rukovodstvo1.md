...
Изменение параметров позволяет создавать сложные траектории и новые сценарии движения. Примеры - на [странице с математическими рисунками](/ru/math_drawings_ru).
