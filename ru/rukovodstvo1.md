...
Прежде чем использовать набор с детьми, мы рекомендуем учителям и родителям прочитать ![Инструкцию по применению](instrukciya.md) и это Руководство для учителя. Для обучения с помощью PrimaSTEM не требуется специальных навыков программирования. Это руководство даст вам основы, необходимые для начала.
...
> **Важно:** Пульт сохраняет последнее установленное значение для команды движения или поворота.
